...
def main():
    ...
    #         positive_proportion = count_positive_windows(testing_captures[2], ground_truth_dbc_path, freq, window, offset, injection_interval)
    ...
    for testing_capture in testing_captures:
        ...
        p = Process(target=count_positive_windows_parallel, args=(testing_capture, ground_truth_dbc_path, freq, attack_metadata, dataset))
