...
def main():
    ...
    # testing_capture = testing_captures[4]
    ...
    for testing_capture in testing_captures:
        ...
        p = Process(target=process_testing_captures_parallel_AHC_ROAD, args=(testing_capture, ground_truth_dbc_path, attack_metadata, freq, 
                                                                   method, dataset, corr_matrices_training[0], signals_training))
